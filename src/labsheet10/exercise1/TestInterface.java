...
public class TestInterface {
    public static void main(String args[]) {
        ...
        PermanentLecturer pl1 = new PermanentLecturer("Thomas Aquais","Dublin",new GregorianCalendar(1984,11,31),"52673",
        ...
        //System.out.println("\n\nTesting out the TemporaryLecturer multi-arg constructor: ");

        TemporaryLecturer tl1 = new TemporaryLecturer("Richard O Neill", "Tallaght, Dublin",new GregorianCalendar(1985,2,4),"3536278b",
                new String[]{"Biology","Microbiology"},new GregorianCalendar(2016,2,8),1342);
        ...
        TemporaryLecturer tl2 = new TemporaryLecturer("Mary McKenzie","Bundoran, Donegal",new GregorianCalendar(1971,5,13),"647382",
                new String[]{"Fractal Geometry","Tensors"},new GregorianCalendar(2016,2,8),1382);

        Person[] allPersons ={u1,u2,p1,p2,pl1,pl2,tl1,tl2};

        System.out.println("\n\nTesting the functionality of PermanentLecturer, as well as UnderGraduate and PostGraduate,\n" +
