...
//Validator.java
/*
An instantiable class that validates the registration details of the Car class
 */

public class Validator {
    //The following algorithm is taken and modified from lab 10 last year

    public static boolean isValidRegistration(String registrationNumber){
