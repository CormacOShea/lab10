...
public class RollTheDice {
    public static void main(String[] args) {
        ...
        while(answer.equals("yes"))
        {
            ...
            +draws, "Game Info", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static char rollTheDice()
    {
        ...
        + "\n......... now hit return to see the player roll","ComputerRoll", JOptionPane.INFORMATION_MESSAGE);

        playerRoll = (int)(Math.random()*11)+2;
        JOptionPane.showMessageDialog(null,"The player roll generated the value " +
