...
public class ComputerData {
    public static void main(String[] args) {
        ...
        while(!serialNumber.equals(""))
        {
            ...
            if(numProcessed > 0)
                 JOptionPane.showMessageDialog(null,"\n\nThe average disk space" +
                         "available on the computers processor is " + String.format("%.0f",
                 averageDiskSpace(totalDiskSpace,numProcessed)) + "GB\nThe price range of the computers is from $" +
                         String.format("%.2f", cheapest) + String.format("%.2f", dearest) + "\nThe processor type +" +
